...
export function Header() {
  ...
  return (
    <header className="sticky top-0 z-50 w-full border-b border-border/70 bg-white/95 dark:bg-slate-950/90 supports-[backdrop-filter]:backdrop-blur-lg shadow-sm">
