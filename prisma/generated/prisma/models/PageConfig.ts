...
export type PageConfigWhereInput = {
  ...
  key?: Prisma.StringFilter<"PageConfig"> | string
  value?: Prisma.StringFilter<"PageConfig"> | string
...
export type PageConfigScalarWhereWithAggregatesInput = {
  ...
  key?: Prisma.StringWithAggregatesFilter<"PageConfig"> | string
  value?: Prisma.StringWithAggregatesFilter<"PageConfig"> | string
...
export type PageConfigOmit<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> = runtime.Types.Extensions.GetOmit<"key" | "value" | "updatedAt", ExtArgs["result"]["pageConfig"]>
...
export interface PageConfigDelegate<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs, GlobalOmitOptions = {}> {
   ...
   * 
   * // Only select the `key`
   * const pageConfigWithKeyOnly = await prisma.pageConfig.findMany({ select: { key: true } })
   * 
   */
   ...
   * })
   * 
   * // Create many PageConfigs and only return the `key`
   * const pageConfigWithKeyOnly = await prisma.pageConfig.createManyAndReturn({
   *   select: { key: true },
   *   data: [
   *     // ... provide data here
   *   ]
   ...
   * })
   * 
   * // Update zero or more PageConfigs and only return the `key`
   * const pageConfigWithKeyOnly = await prisma.pageConfig.updateManyAndReturn({
   *   select: { key: true },
   *   where: {
   *     // ... provide filter here
   *   },
...
export interface PageConfigFieldRefs {
  readonly key: Prisma.FieldRef<"PageConfig", 'String'>
  readonly value: Prisma.FieldRef<"PageConfig", 'String'>
