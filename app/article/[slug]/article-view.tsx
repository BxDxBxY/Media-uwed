...
import { Clock, Share2, ArrowLeft, Bookmark, MessageSquare } from "lucide-react";
...
/**
 * Reading view for a single article.
 *
 * The article itself is fetched on the server (see `page.tsx`) and handed in as
 * `article`, so the full text is present in the initial HTML for crawlers and social
