...
import { Search, Filter, Loader2, ArrowRight, Grid, List as ListIcon } from "lucide-react";
                    ...
                    <div className="flex flex-wrap gap-2">
                        {categories.map((cat) => (
                            <button
                                ...
                                className={`px-4 py-1.5 rounded-full text-sm font-bold transition-all ${activeCategory === cat
                    ...
                    <div className="flex gap-4 w-full lg:w-auto">
                        ...
                        <div className="flex bg-muted p-1 rounded-lg">
                            <button
                                ...
                                className={`p-1.5 rounded-md transition-all ${viewMode === "grid" ? "bg-background shadow-sm text-primary" : "text-muted-foreground"}`}
                            >
