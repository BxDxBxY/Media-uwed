...
import { Mail, MessageSquare, User, Calendar, CheckCircle2, MoreHorizontal, Inbox, Loader2, Send } from "lucide-react";
    ...
    <div className="container mx-auto px-4 py-8 space-y-6">
      <div className="rounded-xl border border-border/40 bg-card p-5 space-y-4">
        ...
        <div className="grid md:grid-cols-3 gap-3">
          <select value={outreachMode} onChange={(e) => setOutreachMode(e.target.value as any)} className="rounded-md border border-input bg-background px-3 py-2 text-sm">
          ...
          {outreachMode === "single" && <input value={outreachEmail} onChange={(e) => setOutreachEmail(e.target.value)} placeholder="recipient@example.com" className="rounded-md border border-input bg-background px-3 py-2 text-sm" />}
